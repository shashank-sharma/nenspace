 ...
 * Used by StatusIndicator and other draggable components.
 * 
 * Features:
...
const logger = createLogger('[DraggableUtil]');
...
export function loadPosition(
    ...
    try {
        ...
        logger.warn(`Failed to parse ${storageKey}, using default position`, error);
...
export function savePosition(storageKey: string, position: Position): void {
    ...
    try {
        ...
        logger.warn(`Failed to save position to ${storageKey}`, error);
    }
}
